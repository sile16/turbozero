...
# =============================================================================
# 6-way value head functions (legacy, for backwards compatibility)
# =============================================================================

def normalize_value_probs(value_head_output: chex.Array) -> chex.Array:
    """Ensure value head output is a proper probability distribution (6-way softmax)."""
...
def terminal_value_probs_from_reward(reward: chex.Array) -> chex.Array:
    """Map a signed reward (money play-style points) to a one-hot outcome vector (6-way)."""
...
def probs_to_equity_4way(
    ...
    to [0, 1] range for consistency with the 6-way version.
